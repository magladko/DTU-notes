chapter \<open>Proof Systems for First-Order Logic: Natural Deduction & Sequent Calculus\<close>

text \<open>

MiniCalc - Part of the Proof Project: \<^url>\<open>https://proof.compute.dtu.dk/\<close>

Authors: Asta Halkjær Boserup, Anders Schlichtkrull & Jørgen Villadsen

License: \<^url>\<open>https://www.isa-afp.org/LICENSE\<close>
...
Abstract: MiniCalc is a web app for teaching first-order logic based on a minimal sequent calculus.
As an option the proofs can be verified in the Isabelle proof assistant. We present the lessons
learned using the tool in recent years at our university.

In Julien Narboux, Walther Neuper and Pedro Quaresma: Proceedings The 13th International Workshop
on Theorem proving components for Educational software (ThEdu24), Nancy, France, 1-2nd July 2024,
Electronic Proceedings in Theoretical Computer Science 419, pp. 75–89.

Published 25 May 2025 \<^url>\<open>https://eptcs.org/paper.cgi?ThEdu24.5\<close>

ArXiv: \<^url>\<open>https://dx.doi.org/10.4204/EPTCS.419.5\<close>

\<close>

theory MiniCalc imports Main begin
...
subsection \<open>Equivalent Proof System\<close>
...
text \<open>Use the derived rule Ext instead of Extra and do not allow Falsity and Truth\<close>
...
next
  ...
  then show ?case
    ...
    by (metis nat_le_linear set_ConsD)
qed
...
section \<open>Main Result for Sequent Calculus\<close>
...
section \<open>Proof of formula (\<forall>x. p \<and> q x) \<longrightarrow> q a \<and> p (Main Example)\<close>

term \<open>(\<forall>x. (p \<and> (q x))) \<longrightarrow> ((q a) \<and> p)\<close>

proposition \<open>(\<forall>x. (p \<and> (q x))) \<longrightarrow> ((q a) \<and> p)\<close> by metis
...
lemma \<open>\<tturnstile>
  [
    Imp (Uni (Con (Pre ''p'' []) (Pre ''q'' [Var 0]))) (Con (Pre ''q'' [Fun ''a'' []]) (Pre ''p'' []))
  ]
  \<close>
proof -
  from Imp_R have ?thesis if \<open>\<tturnstile>
    [
      Neg (Uni (Con (Pre ''p'' []) (Pre ''q'' [Var 0]))),
      Con (Pre ''q'' [Fun ''a'' []]) (Pre ''p'' [])
    ]
    \<close>
    using that by simp
  with Uni_L[where t=\<open>Fun ''a'' []\<close>] have ?thesis if \<open>\<tturnstile>
    [
      Neg (Con (Pre ''p'' []) (Pre ''q'' [Fun ''a'' []])),
      Con (Pre ''q'' [Fun ''a'' []]) (Pre ''p'' [])
    ]
    \<close>
    using that by simp
...
(* (\<forall>x. (p \<and> (q x))) \<longrightarrow> ((q a) \<and> p) *)
...
term \<open>(p \<and> (q (f a (g b)))) \<longrightarrow> p\<close>
...
lemma \<open>\<tturnstile>
  [
    Dis (Pre ''p'' [Fun ''a'' [], Fun ''b'' []]) (Neg (Pre ''p'' [Fun ''a'' [], Fun ''b'' []]))
  ]
  \<close>
proof -
...
proposition \<open>(p \<and> (q (f a (g b)))) \<longrightarrow> p\<close> by metis
...
lemma \<open>\<tturnstile>
  [
    Imp (Con (Pre ''p'' []) (Pre ''q'' [Fun ''f'' [Fun ''a'' [], Fun ''g'' [Fun ''b'' []]]])) (Pre ''p'' [])
  ]
  \<close>
proof -
  from Imp_R have ?thesis if \<open>\<tturnstile>
    [
      Neg (Con (Pre ''p'' []) (Pre ''q'' [Fun ''f'' [Fun ''a'' [], Fun ''g'' [Fun ''b'' []]]])),
      Pre ''p'' []
    ]
    \<close>
    using that by simp
  with Con_L have ?thesis if \<open>\<tturnstile>
    [
      Neg (Pre ''p'' []),
      Neg (Pre ''q'' [Fun ''f'' [Fun ''a'' [], Fun ''g'' [Fun ''b'' []]]]),
      Pre ''p'' []
    ]
    \<close>
    using that by simp
...
lemma \<open>\<tturnstile>
  [
    Imp (Uni (Uni (Pre ''p'' [Var 1, Var 0]))) (Pre ''p'' [Fun ''a'' [], Fun ''a'' []])
  ]
  \<close>
proof -
  from Imp_R have ?thesis if \<open>\<tturnstile>
    [
      Neg (Uni (Uni (Pre ''p'' [Var 1, Var 0]))),
      Pre ''p'' [Fun ''a'' [], Fun ''a'' []]
    ]
    \<close>
    using that by simp
...
lemma \<open>\<tturnstile>
  [
    Imp (Uni (Imp (Pre ''p'' [Var 0]) (Pre ''q'' [Var 0]))) (Imp (Exi (Pre ''p'' [Var 0])) (Exi (Pre ''q'' [Var 0])))
  ]
  \<close>
proof -
  from Imp_R have ?thesis if \<open>\<tturnstile>
...
(* (p \<and> (q (f a (g b)))) \<longrightarrow> p *)
...
theorem "semantics e f g (Imp (Pre ''A'' []) (Pre ''A'' []))"
proof (rule soundness)
  show "OK (Imp (Pre ''A'' []) (Pre ''A'' [])) []"
  proof (rule Imp_I)
    show "OK (Pre ''A'' []) [Pre ''A'' []]"
      by (rule Assume) simp
  qed
...
theorem "semantics e f g (Imp Falsity Falsity)"
proof (rule soundness)
  show "OK (Imp Falsity Falsity) []"
  proof (rule Imp_I)
    show "OK Falsity [Falsity]"
      by (rule Assume) simp
  qed
qed

theorem "semantics e f g (Imp Falsity (Pre ''A'' []))"
proof (rule soundness)
  show "OK (Imp Falsity (Pre ''A'' [])) []"
  proof (rule Imp_I)
    show "OK (Pre ''A'' []) [Falsity]"
    proof (rule Boole)
      show "OK Falsity [Imp (Pre ''A'' []) Falsity, Falsity]"
        by (rule Assume) simp
    qed
  qed
qed

proposition "? x. (A(x) --> (! y. A(y)))"
  by blast

theorem "semantics e f g (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0]))))"
proof (rule soundness)
  show "OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) []"
  proof (rule Boole)
    show "OK Falsity [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
    proof (rule Imp_E)
      show "OK (Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
        by (rule Assume) simp
    next
      show "OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
      proof (rule Exi_I)
        have "OK (Imp (Pre ''A'' [Fun ''c'' []]) (Uni (Pre ''A'' [Var 0]))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
        proof (rule Imp_I)
          show "OK (Uni (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
          proof (rule Uni_I)
            have "OK (Pre ''A'' [Fun ''c*'' []]) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
            proof (rule Boole)
              show "OK Falsity [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
              proof (rule Imp_E)
                show "OK (Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                  by (rule Assume) simp
              next
                show "OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                proof (rule Exi_I)
                  have "OK (Imp (Pre ''A'' [Fun ''c*'' []]) (Uni (Pre ''A'' [Var 0]))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                  proof (rule Imp_I)
                    show "OK (Uni (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                    proof (rule Boole)
                      show "OK Falsity [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                      proof (rule Imp_E)
                        show "OK (Imp (Pre ''A'' [Fun ''c*'' []]) Falsity) [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                          by (rule Assume) simp
                      next
                        show "OK (Pre ''A'' [Fun ''c*'' []]) [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                          by (rule Assume) simp
                      qed
                    qed
                  qed
                  then show "OK (sub 0 (Fun ''c*'' []) (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
                    by simp
                qed
              qed
            qed
            then show "OK (sub 0 (Fun ''c*'' []) (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
              by simp
          qed simp
        qed
        then show "OK (sub 0 (Fun ''c'' []) (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]"
          by simp
      qed
    qed
  qed
...
proposition \<open>\<exists>x. (A(x) \<longrightarrow> (\<forall>y. A(y)))\<close>
  by blast

lemma as_given_by_the_user:
  \<open>OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) []\<close>
proof (rule Boole)
  show \<open>OK Falsity [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
  proof (rule Imp_E)
    show \<open>OK (Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
      by (rule Assume) simp
  next
    show \<open>OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
    proof (rule Exi_I)
      have \<open>OK (Imp (Pre ''A'' [Fun ''c'' []]) (Uni (Pre ''A'' [Var 0]))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
      proof (rule Imp_I)
        show \<open>OK (Uni (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
        proof (rule Uni_I)
          have \<open>OK (Pre ''A'' [Fun ''c*'' []]) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
          proof (rule Boole)
            show \<open>OK Falsity [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
            proof (rule Imp_E)
              show \<open>OK (Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                by (rule Assume) simp
            next
              show \<open>OK (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
              proof (rule Exi_I)
                have \<open>OK (Imp (Pre ''A'' [Fun ''c*'' []]) (Uni (Pre ''A'' [Var 0]))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                proof (rule Imp_I)
                  show \<open>OK (Uni (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                  proof (rule Boole)
                    show \<open>OK Falsity [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                    proof (rule Imp_E)
                      show \<open>OK (Imp (Pre ''A'' [Fun ''c*'' []]) Falsity) [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                        by (rule Assume) simp
                    next
                      show \<open>OK (Pre ''A'' [Fun ''c*'' []]) [Imp (Uni (Pre ''A'' [Var 0])) Falsity, Pre ''A'' [Fun ''c*'' []], Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                        by (rule Assume) simp
                    qed
                  qed
                qed
                then show \<open>OK (sub 0 (Fun ''c*'' []) (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Pre ''A'' [Fun ''c*'' []]) Falsity, Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
                  by simp
              qed
            qed
          qed
          then show \<open>OK (sub 0 (Fun ''c*'' []) (Pre ''A'' [Var 0])) [Pre ''A'' [Fun ''c'' []], Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
            by simp
        qed simp
      qed
      then show \<open>OK (sub 0 (Fun ''c'' []) (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) [Imp (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))) Falsity]\<close>
        by simp
    qed
  qed
qed

theorem \<open>semantics e f g (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0]))))\<close>
  using as_given_by_the_user soundness by blast

lemma as_given_by_the_user_any_unis:
  \<open>semantics e f g (put_unis m (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0])))))\<close>
proof -
  have \<open>OK (put_unis 0 (Exi (Imp (Pre ''A'' [Var 0]) (Uni (Pre ''A'' [Var 0]))))) []\<close>
    unfolding put_unis_def using as_given_by_the_user by simp
  then show ?thesis
    using any_unis soundness by blast
qed
...
Based on Stefan Berghofer (2007): First-Order Logic According to Fitting.
Isabelle Archive of Formal Proofs: \<^url>\<open>https://isa-afp.org/entries/FOL-Fitting.shtml\<close>
